...
int main() {
    ...
    //performanceTest(A, B, "Blocked Multiplication: ", matrixMultiplicationBlocked1);
    // performanceTest(A, B, "Blocked Multiplication: ", matrixMultiplicationBlocked2);
