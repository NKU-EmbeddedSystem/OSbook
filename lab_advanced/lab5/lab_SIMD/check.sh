...
# 目录1和目录2的路径
std_dir="output/standard_result/"
res_dir="output/result/"

# 计算目录1和目录2下所有文件的MD5值
md5_list1=$(calculate_md5 "$res_dir")
md5_list2=($(calculate_md5 "$std_dir") $(calculate_md5 "$std_dir") $(calculate_md5 "$std_dir"))
md5_list2=${md5_list2[@]}
...
# 计算目录下的文件总数
file_count=$(find "$res_dir" -type f | wc -l)
echo "目录 $res_dir 下的文件总数为: $file_count"
